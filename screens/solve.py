...
class SolveScreen(Screen):
    BINDINGS = [
        ...
        Binding("ctrl+d", "mark_done", "Mark Done"),
        Binding("ctrl+l", "toggle_lang", "Switch Lang"),
        Binding("ctrl+b", "toggle_bookmark", "Bookmark"),
        Binding("ctrl+t", "toggle_timer", "Timer"),
        Binding("ctrl+r", "reset_timer", "Reset Timer"),
    ]
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Static(
            f" {status}  |  ^S Save  ^D Done  ^L Lang  ^B Bookmark  ^T Timer  ^R Reset  |  Esc: Back",
            id="status-bar",
        )
        yield Footer()
    ...
    def _refresh_status(self, flash: str | None = None):
        ...
        self.query_one("#status-bar", Static).update(
            f" {marker}{extra}  ^S Save  ^D Done  ^L Lang  ^B Bookmark  ^T Timer  ^R Reset  |  Esc: Back"
        )
