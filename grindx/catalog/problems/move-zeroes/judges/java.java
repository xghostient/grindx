...
static List<Integer> toIntList(Object raw) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("move-zeroes");
    ...
    if (!Arrays.equals(nums, expected)) Common.reportWA(i, input, Arrays.toString(expected), Arrays.toString(nums), total, (String) c.getOrDefault("category", ""));
