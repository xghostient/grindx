...
static boolean validCourseOrder(int[] order, int numCourses, int[][] prerequisites) {
    ...
    return true;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("eventual-safe-states");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    List<Object> input = (List<Object>) c.get("input");
    int[][] graph = Common.toIntMatrix((List<Object>) input.get(0));
    int[] actual = new Solution().eventualSafeNodes(cloneMatrix(graph));
