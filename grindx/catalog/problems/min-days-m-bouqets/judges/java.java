...
static int[][] toIntMatrix(Object raw) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("min-days-m-bouqets");
            ...
            int mVal = Common.toInt(input.get(1));
            int kVal = Common.toInt(input.get(2));
            int actual = new Solution().minDays(arr, mVal, kVal);
