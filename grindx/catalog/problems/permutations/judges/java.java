...
static List<List<Integer>> normalizeIntMatrixKeepInner(int[][] raw) {
    ...
    return rows;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("permutations");
    ...
    List<List<Integer>> actual = normalizeIntMatrixKeepInner(new Solution().permute(nums));
