...
static String intMatrixString(int[][] arr) {
    return Arrays.deepToString(arr);
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("binary-tree-right-side-view");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    int[] actual = new Solution().rightSideView(listToTree((List<Object>) ((List<Object>) c.get("input")).get(0)));
    String actualStr = intListString(actual);
