...
static char[] toCharArray(Object raw) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("divide-arr-in-sets-of-k-consec-numbers");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
                for (int i = 0; i < cases.size(); i++) {
                    Map<String, Object> c = (Map<String, Object>) cases.get(i);
                    List<Object> input = (List<Object>) c.get("input");
                    boolean actual = new Solution().isPossibleDivide(toIntArray(input.get(0)), Common.toInt(input.get(1)));
