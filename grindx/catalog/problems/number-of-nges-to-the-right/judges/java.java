...
static List<String> normalizeStringResult(Object raw) {
    ...
    return new ArrayList<>();
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("number-of-nges-to-the-right");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    List<Object> input = (List<Object>) c.get("input");
    int[] arr = toIntArray((List<Object>) input.get(0));
    int[] queries = toIntArray((List<Object>) input.get(1));
    int[] actual = new Solution().countNGEs(arr, queries);
