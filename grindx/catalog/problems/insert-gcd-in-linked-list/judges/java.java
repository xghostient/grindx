...
class Judge {
    ...
    public static void main(String[] args) {
        Map<String, Object> tc = Common.loadCases("insert-gcd-in-linked-list");
        ...
        for (int i = 0; i < cases.size(); i++) {
            ...
            List<Integer> actual = linkedListToList(new Solution().insertGreatestCommonDivisors(listToLinkedList(arr)));
