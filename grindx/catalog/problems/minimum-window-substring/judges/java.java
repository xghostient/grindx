...
static int[] toIntArray(List<Object> raw) {
    ...
    return true;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("minimum-window-substring");
    ...
    if (!isValidMinWindow(s, t, expected, actual)) Common.reportWA(i, input, expected, actual, total, (String) c.getOrDefault("category", ""));
