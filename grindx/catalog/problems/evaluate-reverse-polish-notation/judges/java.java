...
static List<String> normalizeStringResult(Object raw) {
    ...
    return new ArrayList<>();
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("evaluate-reverse-polish-notation");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    List<Object> input = (List<Object>) c.get("input");
    String[] rows = toStringList((List<Object>) input.get(0)).toArray(new String[0]);
    int actual = new Solution().evalRPN(Arrays.copyOf(rows, rows.length));
