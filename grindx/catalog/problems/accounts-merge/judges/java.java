...
static List<List<String>> normalizeAccounts(String[][] accounts) {
    ...
    return result;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("accounts-merge");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    List<Object> input = (List<Object>) c.get("input");
    String[][] accounts = toStringMatrix((List<Object>) input.get(0));
    List<List<String>> actual = normalizeAccounts(new Solution().accountsMerge(accounts));
    List<List<String>> expected = normalizeAccounts(toStringMatrix((List<Object>) c.get("expected")));
