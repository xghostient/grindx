...
static List<List<String>> normalizeStrMatrix(String[][] raw) {
    ...
    return rows;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("palindrome-partitioning");
    ...
    List<List<String>> actual = normalizeStrMatrix(new Solution().partition(s));
    List<List<String>> expected = new ArrayList<>();
    for (Object row : (List<Object>) c.get("expected")) {
        List<String> r = new ArrayList<>();
        for (Object v : (List<Object>) row) r.add(String.valueOf(v));
        expected.add(r);
    }
