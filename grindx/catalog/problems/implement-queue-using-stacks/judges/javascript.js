        ...
        const Cls = result.MyQueue;
        if (typeof Cls !== "function") {
          process.stderr.write("Solution does not define a MyQueue class\n");
          process.exit(2);
        }
        const tc = loadCases("implement-queue-using-stacks");
