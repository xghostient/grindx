...
static String[] deriveProbeStrings(String[] strs) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("group-anagrams");
    ...
    List<List<String>> actual = normalizeStringGroups(new Solution().groupAnagrams(Arrays.copyOf(strs, strs.length)));
    List<List<String>> expected = normalizeRawStringGroups((List<Object>) c.get("expected"));
