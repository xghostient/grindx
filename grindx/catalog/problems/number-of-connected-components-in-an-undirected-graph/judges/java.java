...
static boolean validCourseOrder(int[] order, int numCourses, int[][] prerequisites) {
    ...
    return true;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("number-of-connected-components-in-an-undirected-graph");
    ...
    int[][] edges = Common.toIntMatrix((List<Object>) input.get(1));
    int actual = new Solution().countComponents(n, cloneMatrix(edges));
