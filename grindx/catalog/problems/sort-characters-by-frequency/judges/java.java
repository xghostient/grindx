...
static boolean isValidFrequencySort(String source, String actual) {
    ...
    return true;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("sort-characters-by-frequency");
    ...
    if (!isValidFrequencySort(s, actual)) {
        Common.reportWA(i, input, "valid frequency-sorted string", actual, total, (String) c.getOrDefault("category", ""));
    }
