...
static List<String> normalizeStringResult(Object raw) {
    ...
    return new ArrayList<>();
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("maximal-rectangle");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    List<Object> input = (List<Object>) c.get("input");
    char[][] rows = Common.toCharMatrix((List<Object>) input.get(0));
    int actual = new Solution().maximalRectangle(rows);
