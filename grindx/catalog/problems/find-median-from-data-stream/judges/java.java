...
static char[] toCharArray(Object raw) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("find-median-from-data-stream");
                ...
                for (int i = 0; i < cases.size(); i++) {
                    ...
                    for (int j = 0; j < ops.size(); j++) {
                        ...
                        Object actual = null;
                                    if (op.equals("addNum")) {
                                        obj.AddNum(Common.toInt(argsIn.get(0))); actual = null;
                                    }
                                    if (op.equals("findMedian")) {
                                        actual = obj.FindMedian();
                                    }
