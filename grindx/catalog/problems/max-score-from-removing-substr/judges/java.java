...
static boolean isValidFrequencySort(String source, String actual) {
    ...
    return true;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("max-score-from-removing-substr");
    ...
    int x = ((Number) input.get(1)).intValue();
    int y = ((Number) input.get(2)).intValue();
    int actual = new Solution().maximumGain(s, x, y);
    int expected = ((Number) c.get("expected")).intValue();
    if (actual != expected) {
