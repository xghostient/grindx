...
static List<String> normalizeStringResult(Object raw) {
    ...
    return new ArrayList<>();
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("remove-k-digits");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    List<Object> input = (List<Object>) c.get("input");
    String num = String.valueOf(input.get(0));
    ...
    if (!Objects.equals(actual, expected)) Common.reportWA(i, input, expected, actual, total, (String) c.getOrDefault("category", ""));
