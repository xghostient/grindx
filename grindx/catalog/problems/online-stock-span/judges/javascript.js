        ...
        const Cls = result.StockSpanner;
        if (typeof Cls !== "function") {
          process.stderr.write("Solution does not define a StockSpanner class\n");
          process.exit(2);
        }
        const tc = loadCases("online-stock-span");
