...
static List<String> normalizeStrList(String[] raw) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("letter-combinations-of-a-phone-number");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    List<Object> input = (List<Object>) c.get("input");
    String digits = String.valueOf(input.get(0));
    List<String> actual = normalizeStrList(new Solution().letterCombinations(digits));
