...
const Cls = result.Trie;
if (typeof Cls !== "function") {
  process.stderr.write("Solution does not define a Trie class\n");
  process.exit(2);
}
const tc = loadCases("implement-trie-prefix-tree");
