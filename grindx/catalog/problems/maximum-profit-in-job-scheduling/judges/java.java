...
static int[][] toIntMatrix(Object raw) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("maximum-profit-in-job-scheduling");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
                for (int i = 0; i < cases.size(); i++) {
            Map<String, Object> c = (Map<String, Object>) cases.get(i);
            List<Object> input = (List<Object>) c.get("input");
            int[] startTime = toIntArray(input.get(0));
            int[] endTime = toIntArray(input.get(1));
            int[] profit = toIntArray(input.get(2));
