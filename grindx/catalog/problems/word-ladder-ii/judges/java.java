...
static boolean validateAlienOrder(String[] words, String order) {
    ...
    return true;
        ...
        public static void main(String[] args) {
            Map<String, Object> tc = Common.loadCases("word-ladder-ii");
        ...
        List<List<String>> actual = normalizePaths(new Solution().findLadders(beginWord, endWord, wordList));
        List<List<String>> expected = normalizePaths(toStringMatrix((List<Object>) c.get("expected")));
