...
static char[] toCharArray(Object raw) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("design-twitter");
                    ...
                    for (int j = 0; j < ops.size(); j++) {
                        ...
                        Object actual = null;
                                    if (op.equals("postTweet")) {
                                        obj.PostTweet(Common.toInt(argsIn.get(0)), Common.toInt(argsIn.get(1))); actual = null;
                                    }
                                    if (op.equals("getNewsFeed")) {
                                        actual = Arrays.stream(obj.GetNewsFeed(Common.toInt(argsIn.get(0)))).boxed().toList();
                                    }
                                    if (op.equals("follow")) {
                                        obj.Follow(Common.toInt(argsIn.get(0)), Common.toInt(argsIn.get(1))); actual = null;
                                    }
                                    if (op.equals("unfollow")) {
                                        obj.Unfollow(Common.toInt(argsIn.get(0)), Common.toInt(argsIn.get(1))); actual = null;
                                    }
