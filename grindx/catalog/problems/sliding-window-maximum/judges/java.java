...
static int[] toIntArray(List<Object> raw) {
    ...
    return true;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("sliding-window-maximum");
    ...
    if (!java.util.Arrays.equals(actual, expected)) Common.reportWA(i, input, java.util.Arrays.toString(expected), java.util.Arrays.toString(actual), total, (String) c.getOrDefault("category", ""));
