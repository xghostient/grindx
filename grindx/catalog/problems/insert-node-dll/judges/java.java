...
class Judge {
    ...
    public static void main(String[] args) {
        Map<String, Object> tc = Common.loadCases("insert-node-dll");
        ...
        for (int i = 0; i < cases.size(); i++) {
            ...
            List<Integer> actual = dllToList(new Solution().insertNode(head, Common.toInt(input.get(1)), Common.toInt(input.get(2))));
