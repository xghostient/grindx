...
static List<Integer> toIntList(Object raw) {
    ...
    return out;
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("better-string");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    List<Object> input = (List<Object>) c.get("input");
    String str1 = String.valueOf(input.get(0));
    String str2 = String.valueOf(input.get(1));
    String actual = new Solution().betterString(str1, str2);
