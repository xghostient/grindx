...
static String intMatrixString(int[][] arr) {
    return Arrays.deepToString(arr);
            ...
            public static void main(String[] args) {
                Map<String, Object> tc = Common.loadCases("serialize-and-deserialize-binary-tree");
                List<Object> cases = (List<Object>) tc.get("cases");
                int total = cases.size();
        Codec codec = new Codec();
for (int i = 0; i < cases.size(); i++) {
    Map<String, Object> c = (Map<String, Object>) cases.get(i);
    TreeNode root = listToTree((List<Object>) ((List<Object>) c.get("input")).get(0));
    List<Object> actual = treeToList(codec.deserialize(codec.serialize(root)));
