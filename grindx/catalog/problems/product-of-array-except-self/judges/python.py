"""Generated judge for product-of-array-except-self."""
...
def run(solution_path: str) -> None:
    ...
    fn = getattr(mod, "productExceptSelf", None)
    if fn is None:
        print("Missing function: productExceptSelf", file=sys.stderr)
        sys.exit(2)

    tc = load_cases("product-of-array-except-self")
    total = len(tc["cases"])
